 ...
 *** Generation date: 2016-03-04 14:41:45
 ***
...
void APSA(void)
{
                  ...
                  if (!(SIBFS_APSA_chart_a.Ca8_Antipinch_Active)) {
                     if (SIBFS_APSA_chart_a.Ca9_WAIT_ADAPT__ON_TIME_FORWARD) {
                        ...
                        if (Ca1_Counter_Time >= ADAPTATION_TIME) {
                           ...
                           /* # combined # BusOutport: APSA/APSA_OUTPUT */
                           APSA_OUTPUT.Threshold_Attention_Update = EERAM_Threshold_Antipinch_Forward / 2;
                              ...
                              if ((APSA_INPUT_Low_Level.Hall_Counter >= ((Ca1_Index_vector * Ca1_Lenght_Segment) + Ca1_Lenght_Segment)) &&
                               (Ca1_Index_vector <= (MAX_NUM_ELEMENT - 1))) {
                                 /* Average_Current += Current;
                                    EERAM_Current_Map_Forward_Write[Index_vector] = Map_Realignment(EERAM_Current_Map_Forward_Read[Index_vector],EERAM
                                    _Threshold_Attention_Higher); */
                                          ...
                                          if ((Delta_Current_actual > APSA_OUTPUT.Threshold_AntiPinch_Update) && (Ca1_cnt_antipinch < T_ANTIPINCH)) {
                                             ...
                                             if (Delta_Current_actual > APSA_OUTPUT.Threshold_Attention_Update) {
                                                ...
                                                /* LOWER_THRESHOLD
                                                   ...
                                                   # combined # BusOutport: APSA/APSA_OUTPUT */
                                                if ((Delta_Current_actual < (-APSA_OUTPUT.Threshold_Attention_Update)) &&
                                                 (EERAM_Current_Map_Forward[Ca1_Index_vector] > MIN_CURRENT_THRESHOLD)) {
                  ...
                  if (!(SIBFS_APSA_chart_a.Ca18_Antipinch_Active)) {
                     if (SIBFS_APSA_chart_a.Ca19_WAIT_ADAP__N_TIME_BACKWARD) {
                        ...
                        if (Ca1_Counter_Time >= ADAPTATION_TIME) {
                           ...
                           /* # combined # BusOutport: APSA/APSA_OUTPUT */
                           APSA_OUTPUT.Threshold_Attention_Update = EERAM_Threshold_Antipinch_Backward / 2;
                           ...
                           if (Ca1_Counter_Time < ADAPTATION_TIME) {
                              ...
                              if ((Sa3_Sum >= ((Ca1_Index_vector * Ca1_Lenght_Segment) + Ca1_Lenght_Segment)) && (Ca1_Index_vector <= (MAX_NUM_ELEMENT
                                - 1))) {
                                 /* Current_Read_Average = Current;
                                    Current_Read_Average = Current_Read / Counter_Sample_Current;
                                    Average_Current += Current_Read_Average;
                                    EERAM_Current_Map_Backward_Write[Index_vector]=Map_Realignment(EERAM_Current_Map_Backward_Read[Index_vector],EERAM
                                    _Threshold_Attention_Lower); */
                                          ...
                                          if ((Delta_Current_actual > APSA_OUTPUT.Threshold_AntiPinch_Update) && (Ca1_cnt_antipinch < T_ANTIPINCH)) {
                                             ...
                                             if (Delta_Current_actual > APSA_OUTPUT.Threshold_Attention_Update) {
                                                ...
                                                /* LOWER_THRESHOLD
                                                   ...
                                                   # combined # BusOutport: APSA/APSA_OUTPUT */
                                                if ((Delta_Current_actual < (-APSA_OUTPUT.Threshold_Attention_Update)) &&
                                                 (EERAM_Current_Map_Backward[Ca1_Index_vector] > MIN_CURRENT_THRESHOLD)) {
   ...
   /* TargetLink outport: APSA/Delta_Current_next */
   Delta_Current_next = 0;
...
static void Ca11_CounterManagerDownFwd(UInt8 Ca11_ResetCounter)
{
   Ca1_BitMaskIndex = Ca1_Index_vector / 8;
   Ca1_BitPosition = Ca1_Index_vector - (Ca1_BitMaskIndex * 8);
   Ca1_BitPosition = ((8 - Ca1_BitPosition) * 2) - 2;
   if (Ca11_ResetCounter == APSA_TRUE) {
      EERAM_CounterVectorDownFwd[Ca1_BitMaskIndex] = 0;
   }
   else {
      if ((EERAM_CounterVectorDownFwd[Ca1_BitMaskIndex] & (COUNT_BIT_TWO << Ca1_BitPosition)) == (COUNT_BIT_TWO << Ca1_BitPosition)) {
         /* {CounterVectorDownFwd_Write[BitMaskIndex] = (CounterVectorFwd_Read[BitMaskIndex] | COUNT_BIT_TWO << (BitPosition) );
            CounterVectorDownFwd_Write[BitMaskIndex] = (CounterVectorFwd_Read[BitMaskIndex] | COUNT_BIT_ONE << (BitPosition) );} */
         ...
         if ((EERAM_CounterVectorDownFwd[Ca1_BitMaskIndex] & (COUNT_BIT_ONE << Ca1_BitPosition)) == (COUNT_BIT_ONE << Ca1_BitPosition)) {
            ...
            /* [(CounterVectorFwd[BitMaskIndex]  & (COUNT_BIT_ONE << ( BitPosition))) != (COUNT_BIT_ONE << BitPosition)] */
            EERAM_CounterVectorDownFwd[Ca1_BitMaskIndex] = EERAM_CounterVectorDownFwd[Ca1_BitMaskIndex] | (COUNT_BIT_ONE << Ca1_BitPosition);
         }
      }
   }
...
static void Ca12_CounterManagerUpFwd(UInt8 Ca12_ResetCounter)
{
   ...
   if (Ca12_ResetCounter == APSA_TRUE) {
      EERAM_CounterVectorUpFwd[Ca1_BitMaskIndex] = 0;
   }
   else {
      if ((EERAM_CounterVectorUpFwd[Ca1_BitMaskIndex] & (COUNT_BIT_TWO << Ca1_BitPosition)) == (COUNT_BIT_TWO << Ca1_BitPosition)) {
         /* {CounterVectorUpFwd_Write[BitMaskIndex] = (CounterVectorUpFwd_Read[BitMaskIndex] | COUNT_BIT_TWO << (BitPosition) );
            CounterVectorUpFwd_Write[BitMaskIndex] = (CounterVectorUpFwd_Read[BitMaskIndex] | COUNT_BIT_ONE << (BitPosition) );} */
...
static void Ca21_CounterManagerDownBwd(UInt8 Ca21_ResetCounter)
{
   ...
   if (Ca21_ResetCounter == APSA_TRUE) {
      EERAM_CounterVectorDownBwd[Ca1_BitMaskIndex] = 0;
   }
   else {
      /* Counter = 3 */
      if ((EERAM_CounterVectorDownBwd[Ca1_BitMaskIndex] & (COUNT_BIT_TWO << Ca1_BitPosition)) == (COUNT_BIT_TWO << Ca1_BitPosition)) {
         /* {CounterVectorBwd[BitMaskIndex] = (CounterVectorBwd[BitMaskIndex] | COUNT_BIT_TWO << (BitPosition) );
            CounterVectorBwd[BitMaskIndex] = (CounterVectorBwd[BitMaskIndex] | COUNT_BIT_ONE << (BitPosition) );} */
         ...
         if ((EERAM_CounterVectorDownBwd[Ca1_BitMaskIndex] & (COUNT_BIT_ONE << Ca1_BitPosition)) == (COUNT_BIT_ONE << Ca1_BitPosition)) {
            ...
            /* Counter = 1
               [(CounterVectorBwd_Read[BitMaskIndex]  & (COUNT_BIT_ONE << ( BitPosition))) != (COUNT_BIT_ONE << BitPosition)] */
            EERAM_CounterVectorDownBwd[Ca1_BitMaskIndex] = EERAM_CounterVectorDownBwd[Ca1_BitMaskIndex] | (COUNT_BIT_ONE << Ca1_BitPosition);
         }
      }
   }
...
static void Ca22_CounterManagerUpBwd(UInt8 Ca22_ResetCounter)
{
   ...
   if (Ca22_ResetCounter == APSA_TRUE) {
      EERAM_CounterVectorUpBwd[Ca1_BitMaskIndex] = 0;
   }
   else {
      /* Counter = 3 */
