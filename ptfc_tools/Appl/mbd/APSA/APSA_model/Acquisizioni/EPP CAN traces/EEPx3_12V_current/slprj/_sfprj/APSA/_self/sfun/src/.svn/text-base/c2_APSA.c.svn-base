...
static void sf_gateway_c2_APSA(SFc2_APSAInstanceStruct *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_Lenght_Motor_Stroke, 1U);
  _SFD_DATA_RANGE_CHECK(chartInstance->c2_index_vector, 2U);
  _SFD_DATA_RANGE_CHECK(chartInstance->c2_mod, 3U);
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c2_Lenght_Segment, 4U);
  _SFD_DATA_RANGE_CHECK(chartInstance->c2_Mod, 5U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_Cmd_Motor, 6U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_Current, 7U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_Hall_Counter_Backward, 8U);
  _SFD_DATA_RANGE_CHECK(chartInstance->c2_Counter_Sample_Current, 9U);
  _SFD_DATA_RANGE_CHECK(chartInstance->c2_Current_Read, 10U);
  _SFD_DATA_RANGE_CHECK(chartInstance->c2_Current_Read_Average, 11U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_Index_vector, 12U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_Mappa, 13U);
  _SFD_DATA_RANGE_CHECK(chartInstance->c2_data, 14U);
  chartInstance->c2_sfEvent = CALL_EVENT;
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1194344842U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2347429392U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1991589507U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1532192364U);
}
...
mxArray *sf_c2_APSA_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("P8yPd70PJWKa5ucfxcm0iD");
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(1,1,1,0,"Lenght_Motor_Stroke");
          _SFD_SET_DATA_PROPS(2,0,0,0,"index_vector");
          _SFD_SET_DATA_PROPS(3,0,0,0,"mod");
          _SFD_SET_DATA_PROPS(4,0,0,0,"Lenght_Segment");
          _SFD_SET_DATA_PROPS(5,0,0,0,"Mod");
          _SFD_SET_DATA_PROPS(6,1,1,0,"Cmd_Motor");
          _SFD_SET_DATA_PROPS(7,1,1,0,"Current");
          _SFD_SET_DATA_PROPS(8,1,1,0,"Hall_Counter_Backward");
          _SFD_SET_DATA_PROPS(9,0,0,0,"Counter_Sample_Current");
          _SFD_SET_DATA_PROPS(10,0,0,0,"Current_Read");
          _SFD_SET_DATA_PROPS(11,0,0,0,"Current_Read_Average");
          _SFD_SET_DATA_PROPS(12,2,0,1,"Index_vector");
          _SFD_SET_DATA_PROPS(13,2,0,1,"Mappa");
          _SFD_SET_DATA_PROPS(14,0,0,0,"data");
        ...
        _SFD_SET_DATA_VALUE_PTR(0U,
          *chartInstance->c2_EERAM_Current_Map_Backward_Write);
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c2_Lenght_Motor_Stroke);
        _SFD_SET_DATA_VALUE_PTR(2U, &chartInstance->c2_index_vector);
        _SFD_SET_DATA_VALUE_PTR(3U, &chartInstance->c2_mod);
        _SFD_SET_DATA_VALUE_PTR(4U, &chartInstance->c2_Lenght_Segment);
        _SFD_SET_DATA_VALUE_PTR(5U, &chartInstance->c2_Mod);
        _SFD_SET_DATA_VALUE_PTR(6U, chartInstance->c2_Cmd_Motor);
        _SFD_SET_DATA_VALUE_PTR(7U, chartInstance->c2_Current);
        _SFD_SET_DATA_VALUE_PTR(8U, chartInstance->c2_Hall_Counter_Backward);
        _SFD_SET_DATA_VALUE_PTR(9U, &chartInstance->c2_Counter_Sample_Current);
        _SFD_SET_DATA_VALUE_PTR(10U, &chartInstance->c2_Current_Read);
        _SFD_SET_DATA_VALUE_PTR(11U, &chartInstance->c2_Current_Read_Average);
        _SFD_SET_DATA_VALUE_PTR(12U, chartInstance->c2_Index_vector);
        _SFD_SET_DATA_VALUE_PTR(13U, chartInstance->c2_Mappa);
        _SFD_SET_DATA_VALUE_PTR(14U, &chartInstance->c2_data);
      }
    } else {
...
static void mdlSetWorkWidths_c2_APSA(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3403022158U));
  ssSetChecksum1(S,(4186821417U));
  ssSetChecksum2(S,(3279759185U));
  ssSetChecksum3(S,(998636657U));
