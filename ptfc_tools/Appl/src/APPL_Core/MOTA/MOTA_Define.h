...
/*Number of hall pulse for obstable repulsion after antipinch (about 3cm) */
#define MOTA_REPULSION    0 /* 168 */

/*Delay applied to slide movement inversion (Easy entry) */
...
#define MOTA_TIMEOUT_LIFT           15000 /*ms*/
#define MOTA_TIMEOUT_TILT           15000 /*ms*/
#define MOTA_TIMEOUT_BACKREST       25000 /*ms*/
