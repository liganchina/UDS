...
/*
	Noise Filter Enable Register 1~3 (NFEN1~3)
*/
...
#define	_01_WAKEUPTM_INTERNAL_CLOCK1			0x01U	/* fSUB */
...
#define _04AF_TAU_TDR01_VALUE				0x04AFU
/* Clock divisor for TAU0 channel1 */
#define _1_TAU0_CHANNEL1_DIVISOR			1U
/* 16-bit timer data register 16 (TDR16) */
#define _EA5F_TAU_TDR16_VALUE				0xEA5FU
/* 16-bit timer data register 17 (TDR17) */
#define _7530_TAU_TDR17_VALUE				0x7530U
/* Clock divisor for TAU1 channel6 */
#define _4_TAU1_CHANNEL6_DIVISOR			4U
/* Clock divisor for TAU1 channel6 */
#define _4_TAU1_CHANNEL7_DIVISOR			4U
/*
*******************************************************************************
**  Function define
*******************************************************************************
