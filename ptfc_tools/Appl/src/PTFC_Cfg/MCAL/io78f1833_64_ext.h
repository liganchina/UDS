/*-------------------------------------------------------------------------
 *      Declarations of extended SFR registers for 78K0R microcontroller uPD78F1833_64.
 *
...
#ifndef __IO78F1833_64_EXT_H__
#define __IO78F1833_64_EXT_H__

#if !defined(__A78K__) && !defined(__ICC78K__)
  #error "IO78F1833_64_EXT.H file for use with 78K Series Assembler or Compiler only"
#endif

#if defined(__A78K__)
  #if __CORE__ != __78K0R__
    #error "IO78F1833_64_EXT.H file for use with A78K0R option --core 78k0r only"
  #endif
#endif
#if defined(__ICC78K__)
  #if __CORE__ != __78K0R__
    #error "IO78F1833_64_EXT.H file for use with ICC78K0R option --core 78k0r only"
  #endif
#endif
