...
typedef unsigned short      uint16_t;     /* short unsigned word (2 bytes) */
typedef signed short        int16_t;      /* short signed word   (2 bytes) */
typedef unsigned long       uint32_t;     /* long unsigned word  (4 bytes) */
typedef signed long         int32_t;      /* long signed word    (4 bytes) */



#endif /* end __TYPEDEFS_H */
